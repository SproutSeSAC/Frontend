...
export default function MembershipLeaveModal() {
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-darkGray-active">
        새싹에서 제공하는 취업정보와 다른 사람들과의 네트워킹도 더 이상 이용하실
        수 없게 돼요
      </p>
      <p className="mt-2 text-darkGray-active">정말 탈퇴하시겠어요?</p>
      ...
      >
        ...
        />
        <p className={`${isActive ? 'text-black' : 'text-mainGray-active'}`}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <textarea
          ...
          className="min-h-48 w-full resize-none rounded-lg border bg-lightGray p-4 outline-none placeholder:text-darkGray"
          placeholder="서비스 탈퇴 사유에 대해 알려주세요. 소중한 피드백을 담아 더 나은 서비스로 보답 드리도록 하겠습니다."
        />
        <div className="mb-4 mt-16 flex gap-4">
          <SquareButton
            type="button"
            name="취소"
